...
export class LivroComponent implements OnInit { 
    ...
    convertForm(livroModel: LivroModel) {
        ...
        this.livroForm.controls['imagem'].setValue(livroModel.imagem);
        this.livroForm.controls['paginas'].setValue(livroModel.paginas);
        this.livroForm.controls['edicao'].setValue(livroModel.edicao);
        this.livroForm.controls['idioma'].setValue(livroModel.idioma);
        this.livroForm.controls['editora'].setValue(livroModel.editora);
    ...
    convertModel() {
        ...
        this.request.imagem = this.livroForm.controls['imagem'].value;
        this.request.paginas = this.livroForm.controls['paginas'].value;
        this.request.edicao = this.livroForm.controls['edicao'].value;
        this.request.idioma = this.livroForm.controls['idioma'].value;
        this.request.editora = this.livroForm.controls['editora'].value;
