...
export class UsuarioService {
    ...
    getAll(): Observable<ResponseModel> {
        return this.http.get<ResponseModel>(`${environment.baseUrl}/Usuario/ObterListaUsuario`);
    }

    get(idLivro: number): Observable<ResponseModel> {
        return this.http.get<ResponseModel>(`${environment.baseUrl}/Usuario/ObterUsuario/${idLivro}`);
    } 
