...
export class LivroService {
  ...
  constructor(private http: HttpClient, private authenticationService: AuthenticationService) {
    ...
    getAll(): Observable<ResponseModel> {
        return this.http.get<ResponseModel>(`${environment.baseUrl}/Livro/ObterListaLivro`);
    }

    get(idLivro: number): Observable<ResponseModel> {
        return this.http.get<ResponseModel>(`${environment.baseUrl}/Livro/ObterLivro/${idLivro}`);
    } 
