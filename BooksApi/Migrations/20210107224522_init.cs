    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "PEDRO SILVA", "", "123456785", false, "mauris cursus mattis molestie a iaculis at erat pellentesque adipiscing commodo elit at imperdiet dui accumsan sit amet nulla facilisi morbi tempus iaculis urna id volutpat lacus laoreet non curabitur gravida arcu ac tortor dignissim convallis aenean et tortor at risus viverra adipiscing at in tellus integer feugiat scelerisque varius", "Net Core 5.0", 225, 150m, 0m });

            migrationBuilder.InsertData(
                table: "Livros",
                columns: new[] { "Id", "Autor", "ImagemUrl", "Isbn", "Promocao", "Resumo", "Titulo", "TotalPagina", "Valor", "ValorPromocao" },
                values: new object[] { 2, "JOSEFA ANTONIA", "", "123456789101579", false, "mauris cursus mattis molestie a iaculis at erat pellentesque adipiscing commodo elit at imperdiet dui accumsan sit amet nulla facilisi morbi tempus iaculis urna id volutpat lacus laoreet non curabitur gravida arcu ac tortor dignissim convallis aenean et tortor at risus viverra adipiscing at in tellus integer feugiat scelerisque varius", "React ", 250, 80m, 0m });

            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "Id", "Cpf", "Email", "Nome", "NomeUsuario", "Role", "Senha" },
                values: new object[] { 1, null, "jose@email.com", "jose roberto", "jose", "admin", "123456789" });
