...
{
    [TestClass]
    public class AlterarLivroHandlerTest
    {
        ...
        public AlterarLivroHandlerTest()
        {
        ...
        {
            //Arrange
            var handler = new AlterarLivroHandler(_uow, _notifications, _mediator, _livroRepository, _autorRepository, _editoraRepository);
            var command = new AlterarLivroCommand(string.Empty, _livro.Nome, _livro.Descricao, _livro.Autor, _livro.Editora, _livro.Edicao);
            //Act
        ...
        public void NotificacaoNomeInconsistente()
        {
            //Arrange
            var handler = new AlterarLivroHandler(_uow, _notifications, _mediator, _livroRepository, _autorRepository, _editoraRepository);
            var command = new AlterarLivroCommand(_livro.Id.ToString(), string.Empty, _livro.Descricao, _livro.Autor, _livro.Editora, _livro.Edicao);
            //Act
            handler.Handle(command, new CancellationToken(false));
            //Assert
            _mediator.ReceivedWithAnyArgs(2).Publish((INotification)null);
        ...
        public void NotificacaoDescricaoInconsistente()
        {
            //Arrange
            var handler = new AlterarLivroHandler(_uow, _notifications, _mediator, _livroRepository, _autorRepository, _editoraRepository);
            var command = new AlterarLivroCommand(_livro.Id.ToString(), _livro.Nome, string.Empty, _livro.Autor, _livro.Editora, _livro.Edicao);
            //Act
            handler.Handle(command, new CancellationToken(false));
            //Assert
        ...
        public void NotificacaoAutorInconsistente()
        {
            //Arrange
            var handler = new AlterarLivroHandler(_uow, _notifications, _mediator, _livroRepository, _autorRepository, _editoraRepository);
            var command = new AlterarLivroCommand(_livro.Id.ToString(), _livro.Nome, _livro.Descricao, null, _livro.Editora, _livro.Edicao);
            //Act
            handler.Handle(command, new CancellationToken(false));
            //Assert
            _mediator.ReceivedWithAnyArgs(1).Publish((INotification)null);
        ...
        public void NotificacaoEditoraInconsistente()
        {
            //Arrange
            var handler = new AlterarLivroHandler(_uow, _notifications, _mediator, _livroRepository, _autorRepository, _editoraRepository);
            var command = new AlterarLivroCommand(_livro.Id.ToString(), _livro.Nome, _livro.Descricao, _livro.Autor, null, _livro.Edicao);
            //Act
            handler.Handle(command, new CancellationToken(false));
            //Assert
            _mediator.ReceivedWithAnyArgs(1).Publish((INotification)null);
        ...
        public void NotificacaoEdicaoInconsistente()
        {
            //Arrange
            var handler = new AlterarLivroHandler(_uow, _notifications, _mediator, _livroRepository, _autorRepository, _editoraRepository);
            var command = new AlterarLivroCommand(_livro.Id.ToString(), _livro.Nome, _livro.Descricao, _livro.Autor, _livro.Editora, 0);
            //Act
            handler.Handle(command, new CancellationToken(false));
            //Assert
            _mediator.ReceivedWithAnyArgs(1).Publish((INotification)null);
        ...
        public void IdNaoEncontrado()
        {
            ...
            var handler = new AlterarLivroHandler(_uow, _notifications, _mediator, _livroRepository, _autorRepository, _editoraRepository);
            var command = new AlterarLivroCommand(_livro.Id.ToString(), _livro.Nome, _livro.Descricao, _livro.Autor, _livro.Editora, _livro.Edicao);
            //Act
            handler.Handle(command, new CancellationToken(false));
            //Assert
            _mediator.ReceivedWithAnyArgs(1).Publish((INotification)null);
